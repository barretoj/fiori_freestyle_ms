class ZCL_ZJFB_OV_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZJFB_FI_ATUALIZA_STATUS,
        ID_STATUS type C length 1,
        ID_ORDEMID type I,
    end of TS_ZJFB_FI_ATUALIZA_STATUS .
  types:
  begin of TS_OVCAB,
     ORDEMID type I,
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  constants GC_CT_MENSAGEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'CT_Mensagem' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZJFB_OV_MPC===============CP' ##NO_TEXT.
...
CLASS ZCL_ZJFB_OV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZJFB_OV_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJFB_OV_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJFB_OV_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZJFB_OV_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240502195629'.                  "#EC NOTEXT
...
***********************************************************************************************************************************
*   ACTION - ZJFB_FI_ATUALIZA_STATUS
***********************************************************************************************************************************

lo_action = model->create_action( 'ZJFB_FI_ATUALIZA_STATUS' ).  "#EC NOTEXT
*Set return complex type
lo_action->set_return_complex_type( 'CT_Mensagem' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZJFB_OV_MPC=>TS_ZJFB_FI_ATUALIZA_STATUS' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
*   COMPLEX TYPE - CT_Mensagem
***********************************************************************************************************************************
lo_complex_type = model->create_complex_type( 'CT_Mensagem' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZJFB_OV_MPC=>CT_MENSAGEM' ). "#EC NOTEXT
  endmethod.
ENDCLASS.
