class ZCL_ZJFB_OV_MPC_EXT definition
  public
  inheriting from ZCL_ZJFB_OV_MPC
  create public .
...
CLASS ZCL_ZJFB_OV_MPC_EXT IMPLEMENTATION.
  ...
  METHOD define.
    ...
    lo_entity_type->bind_structure( iv_structure_name = 'ZCL_ZJFB_OV_MPC_EXT=>TY_ORDEM_ITEM' ).
